...
class Vertex():
    ...
    def add_edge(self, vertex: 'Vertex') -> None:
        ...
        # TODO Fill this in
        if vertex not in self.edges and isinstance(vertex, Vertex) and vertex != self:
    ...
    def remove_edge(self, vertex: 'Vertex') -> None:
        ...
        # TODO Fill this in
        if vertex in self.edges and isinstance(vertex, Vertex):
